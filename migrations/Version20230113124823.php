 ...
 */
final class Version20230113124823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE historic (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', source_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', historic_type VARCHAR(255) NOT NULL, target_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', message VARCHAR(255) NOT NULL, INDEX IDX_AD52EF56953C1C61 (source_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', commercial_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, validate TINYINT(1) NOT NULL, reset_token VARCHAR(40) DEFAULT NULL, reset_expire DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D6497854071C (commercial_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
